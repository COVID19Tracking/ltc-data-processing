...
_FUNCTION_LISTS = {
    ...
    'CO': [utils.standardize_data, utils.add_ctp_id, aggregate_outbreaks.collapse_outbreak_rows, utils.post_processing],
    'CT': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    'DC': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    'DE': [utils.standardize_data, utils.add_ctp_id, aggregate_outbreaks.collapse_facility_rows_no_adding, utils.post_processing],
    'FL': [
        utils.standardize_data,
        utils.add_ctp_id,
    ...
    'GA': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    ...
    'ID': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    'IL': [utils.standardize_data, utils.add_ctp_id, aggregate_outbreaks.collapse_outbreak_rows, utils.post_processing],
    'IN': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    ...
    'NV': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    'NY': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    'OH': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    'OK': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    'OR': [utils.standardize_data, utils.add_ctp_id, aggregate_outbreaks.collapse_outbreak_rows, utils.post_processing],
    'PA': [utils.standardize_data, utils.add_ctp_id, replace_no_data.replace_no_data, utils.post_processing],
    'RI': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    'SC': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    'TN': [utils.standardize_data, utils.add_ctp_id, close_outbreaks.close_outbreaks, utils.post_processing],
    'TX': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
    'UT': [utils.standardize_data, utils.add_ctp_id, close_outbreaks.close_outbreaks, utils.post_processing],
    'VA': [utils.standardize_data, utils.add_ctp_id, aggregate_outbreaks.collapse_outbreak_rows, utils.post_processing],
    ...
    'WV': [utils.standardize_data, utils.add_ctp_id, utils.post_processing],
